    ...
    <Layout>
      ...
      <div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {/* Web Design */}
          <Card className="bg-card/80 border-border p-6 hover:bg-card/90 transition-all duration-500 shadow-md hover:shadow-xl transform hover:-translate-y-3 hover:scale-100 hover:border-primary/30 group cursor-pointer">
            ...
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 bg-primary/20 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:bg-primary group-hover:scale-110 transition-all duration-300">
                <div
                  ...
                  style={{
                    maskImage:
                      'url(\'data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3l-2.5-3z"/><circle cx="12" cy="13" r="3"/></svg>\')',
                    maskRepeat: "no-repeat",
                    maskPosition: "center",
                  }}
                ></div>
              ...
              <div>
                ...
                <p className="text-muted-foreground group-hover:text-foreground transition-colors duration-300">
                  I enjoy capturing high-quality photos across various categories as a creative hobby.
                </p>
              </div>
            </div>
          </Card>
